...
kubectl set image deployments/client-deployment client=allstarpro/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=allstarpro/multi-worker:$SHA